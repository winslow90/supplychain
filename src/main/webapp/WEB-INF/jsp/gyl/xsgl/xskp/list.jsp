    	...
    	<td id="rig_top" >
            ...
            <table cellspacing="0" cellpadding="0" id="maintain-top" align="center"  width="2000"  style="font-size:12px;">
                <tr class="one">
					...
					<td  width="180">状态</td>
					<td  width="180">制单人</td>
					<td  width="180">制单时间</td>
					<td  width="180">审批人</td>
					<td  width="180">审批时间</td>
					<td  width="180">修改人</td>
                ...
                <td colspan="22" style="border-right:0;border-top:1px solid #8FAFD7;">&nbsp;&nbsp;共有 120 条记录，当前第 1/10 页</td>
    	...
    	<td id="right_center" >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;">
                <tr class="two" align="center">
                    ...
                    <td width="100">单位</td>
                    <td width="100">数量</td>
                    <td width="100">整单折扣</td>
                    <td width="100">单品折扣</td>
					<td width="100">发票折扣</td>
					<td width="100">税率</td>
                ...
                <tr style="background:#ECF4FB; font-size:12px;"  height="30">
                <td colspan="18" style="border-right:0;border-top:1px solid #8FAFD7;">&nbsp;&nbsp;共有 120 条记录，当前第 1/10 页</td>
